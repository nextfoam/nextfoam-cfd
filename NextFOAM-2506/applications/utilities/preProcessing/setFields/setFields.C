...
(
    ...
    Istream& is,
    const bool& writeBoundaryFields
)
{
    ...
    if (found)
    {
        ...
        (
            writeBoundaryFields
         && !mesh.thisDb().time().processorCase()
        )
        {
            field.writeBoundaryField(true);
        }
    }
    else
    {
...
struct setCellField
{
    ...
    )
    {
        return
        (
            setCellFieldType<scalar>(fieldDesc, m, selectedCells, is, wbf)
         || setCellFieldType<vector>(fieldDesc, m, selectedCells, is, wbf)
         ...
         || setCellFieldType<symmTensor>(fieldDesc, m, selectedCells, is, wbf)
         || setCellFieldType<tensor>(fieldDesc, m, selectedCells, is, wbf)
        );
    }
...
struct setFaceField
{
    ...
    )
    {
        return
        (
            setFaceFieldType<scalar>(fieldDesc, m, selectedFaces, is, wbf)
         || setFaceFieldType<vector>(fieldDesc, m, selectedFaces, is, wbf)
         ...
         || setFaceFieldType<symmTensor>(fieldDesc, m, selectedFaces, is, wbf)
         || setFaceFieldType<tensor>(fieldDesc, m, selectedFaces, is, wbf)
        );
    }
...
struct setAreaField
{
    ...
    )
    {
        return
        (
            setAreaFieldType<scalar>(fieldDesc, m, selectedFaces, is, wbf)
         || setAreaFieldType<vector>(fieldDesc, m, selectedFaces, is, wbf)
         || setAreaFieldType<sphericalTensor>
            (
                fieldDesc, 
                m, 
                selectedFaces, 
         ...
         || setAreaFieldType<symmTensor>(fieldDesc, m, selectedFaces, is, wbf)
         || setAreaFieldType<tensor>(fieldDesc, m, selectedFaces, is, wbf)
        );
    }
