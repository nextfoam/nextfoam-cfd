...
bool Foam::solutionControl::read(const bool absTolOnly)
{
    ...
    solveFlow_ = solutionDict.getOrDefault("solveFlow", true); // by Gill
    solveEnergy_ = solutionDict.getOrDefault("solveEnergy", true); // by Gill
    solveSpecies_ = solutionDict.getOrDefault("solveSpecies", true); // by Gill
    nNonOrthCorr_ =
...
:
    ...
    solveFlow_(true), // by Gill
    solveEnergy_(true), // by Gill
    solveSpecies_(true), // by Gill
    nNonOrthCorr_(0),
