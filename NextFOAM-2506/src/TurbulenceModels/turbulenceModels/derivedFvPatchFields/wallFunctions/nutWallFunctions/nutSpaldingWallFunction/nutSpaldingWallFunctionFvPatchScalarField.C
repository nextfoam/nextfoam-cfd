...
Foam::nutSpaldingWallFunctionFvPatchScalarField::calcNut() const
{
...
Foam::tmp<Foam::scalarField>
Foam::nutSpaldingWallFunctionFvPatchScalarField::calcUTau
(
...
void Foam::nutSpaldingWallFunctionFvPatchScalarField::writeLocalEntries
(
    Ostream& os
) const
{
...
nutSpaldingWallFunctionFvPatchScalarField
(
    const nutSpaldingWallFunctionFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
:
    nutWallFunctionFvPatchScalarField(p, iF, dict, 0.09, 0.4187, 9.793),
...
nutSpaldingWallFunctionFvPatchScalarField
(
    const nutSpaldingWallFunctionFvPatchScalarField& wfpsf
)
:
...
~nutSpaldingWallFunctionFvPatchScalarField()
{
    //if (debug)
    //{
    //    Info<< "nutSpaldingWallFunctionFvPatchScalarField :"
    //        << " total invocations:"
...
Foam::tmp<Foam::scalarField>
Foam::nutSpaldingWallFunctionFvPatchScalarField::yPlus() const
{
    const label patchi = patch().index();
...
void Foam::nutSpaldingWallFunctionFvPatchScalarField::write
(
    Ostream& os
) const
{
