...
#include "DVKLimitedGrad.H"
#include "gaussGrad.H"

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

makeFvGradScheme(DVKLimitedGrad)

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

template<class Type>
void Foam::fv::DVKLimitedGrad<Type>::limitGradient
(
...
<
    ...
    >
>
Foam::fv::DVKLimitedGrad<Type>::calcGrad
(
...
) const
{
    ...
    Type vsfMax = max(vsf).value();
    Type vsfMin = min(vsf).value();

    Type eps = K_*(vsfMax - vsfMin);
