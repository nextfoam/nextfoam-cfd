...
3. Fluent boundary types.
    ...
    - Boundary faces labeled as internal (i.e. interior, internal, solid, fan,
    radiator, porous-jump) but that are in fact external boundaries will be 
    added to a default wall boundary.

    - Boundary faces labeled as interface will be added as patches.
    These patches will need to be changed to cyclicAMI later.
