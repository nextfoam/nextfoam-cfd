...
template<class BasicPsiThermo, class MixtureType>
void Foam::hePsiThermo<BasicPsiThermo, MixtureType>::calculateInternal
(
    const volScalarField& p,
    volScalarField& T,
    volScalarField& he,
...
template<class BasicPsiThermo, class MixtureType>
void Foam::hePsiThermo<BasicPsiThermo, MixtureType>::calculateBoundary
(
    const volScalarField& p,
    volScalarField& T,
    volScalarField& he,
...
template<class BasicPsiThermo, class MixtureType>
void Foam::hePsiThermo<BasicPsiThermo, MixtureType>::correctInternal()
{
    DebugInFunction << endl;
...
template<class BasicPsiThermo, class MixtureType>
void Foam::hePsiThermo<BasicPsiThermo, MixtureType>::correctBoundary()
{
    DebugInFunction << endl;
