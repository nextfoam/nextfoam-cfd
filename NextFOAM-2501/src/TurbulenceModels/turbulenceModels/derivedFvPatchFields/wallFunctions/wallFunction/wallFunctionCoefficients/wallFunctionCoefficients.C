...
:
    Cmu_(dict.getOrDefault<scalar>("Cmu", Cmu)),
    kappa_
    (
        dict.getCheckOrDefault<scalar>("kappa", kappa, scalarMinMax::ge(SMALL))
    ),
    E_(dict.getCheckOrDefault<scalar>("E", E, scalarMinMax::ge(SMALL))),
    yPlusLam_(calcYPlusLam(kappa_, E_))
{}
